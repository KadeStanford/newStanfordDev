...
// We use spans here since it's a fixed string that doesn't rely on the TypeAnimation renderer loop
const StaticCode = () => (
  <div
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        {/* Abstract Visual / Code Block - STATIC DISPLAY */}
        <motion.div
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-tr from-slate-800 to-slate-900 rounded-2xl border border-slate-700 transform rotate-3 hover:rotate-0 transition-all duration-500 shadow-2xl overflow-hidden group">
            {/* The Code Window */}
